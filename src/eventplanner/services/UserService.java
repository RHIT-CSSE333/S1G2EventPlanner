...
public class UserService { ;
    ...
    public boolean registerUser(String email, String phoneNo, String firstName, String middleInit, String lastName,
        ...
        try {
            ...
            stmt.setString(4, middleInit);  // Nullable field
            stmt.setString(5, lastName);
            stmt.setString(6, dob);
            stmt.setString(7, ccNum);       // Nullable field
            stmt.setString(8, ccExpDate);   // Nullable field
            stmt.setString(9, cvv);         // Nullable field
